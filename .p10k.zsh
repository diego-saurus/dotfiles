# Generated by Powerlevel10k configuration wizard on 2022-07-27 at 11:30 WIB.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# slanted separators, sharp heads, blurred tails, 2 lines, disconnected, no frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=214
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=29
